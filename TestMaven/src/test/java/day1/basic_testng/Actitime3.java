...
public class Actitime3 extends SeleniumUtility {
	...
	public void verifyTaskCreation() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"//div[@class='customerSelector customerOrProjectSelector selectorWithPlaceholderContainer']/div/div[1]/div[3]")));
		driver.findElement(By.xpath(
				"//div[@class='customerSelector customerOrProjectSelector selectorWithPlaceholderContainer']/div/div[1]/div[3]"))
				.click();
        
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='customerProjectSelectorPlaceholder']/div/table/tbody/tr[1]/td[1]/div/div/div[2]/div/div[1]/div/div")));
		...
		companyList.get(4).click();

		// click on project dropdown
		driver.findElement(By.xpath(
				"//div[@class='projectSelector customerOrProjectSelector selectorWithPlaceholderContainer']/div/div/div[3]"))
				.click();
...
//		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
			...
			taskList = driver.findElements(By.cssSelector(".tasksTableVerticalScrollContainer .title"));// reidentif to
																										// avoid stale
																										// element
																										// exceptions
	...
	public void verifyDeletTask() {
		...
		// click on delet
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='bulkOperationsPanel']/div[6]")));
		driver.findElement(By.xpath("//div[@class='bulkOperationsPanel']/div[6]")).click();
		//WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[text()='Delete permanently']"))).click();
		// delete permentely
