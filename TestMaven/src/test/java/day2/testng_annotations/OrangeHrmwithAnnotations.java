package day2.testng_annotations;
...
public class OrangeHrmwithAnnotations extends SeleniumUtility{

	@BeforeTest
	public void loginOrngeHrm() {
		driver= setUp("chrome", "https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
		driver.findElement(By.name("username")).sendKeys("Admin");
		driver.findElement(By.name("password")).sendKeys("admin123", Keys.ENTER);
	}
	@Test(priority=1)
	public void cratePIM() {
	...
	@Test(priority=2,dependsOnMethods="cratePIM")
	...
	@Test(priority=3,dependsOnMethods="cratePIM")
